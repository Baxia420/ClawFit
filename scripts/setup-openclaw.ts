...
const healthTools = [
  "estimate_nutrition", "log_meal", "update_meal", "delete_meal", "get_meal", "get_recent_meals", "get_daily_nutrition",
...
console.log("ClawFit plugin and least-privilege tool policy configured. Restart the Gateway after model configuration.");
